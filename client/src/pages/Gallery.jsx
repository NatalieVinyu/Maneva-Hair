...
const GALLERY_ITEMS = [
  { id: 1, category: 'Installs', title: 'Curly Water Weave', stylist: 'Aisha', img: Model1, span: 'row-span-2' },
  { id: 2, category: 'Colour', title: 'Black with Blonde Highlights', stylist: 'Lerato', img: Model2, span: '' },
  { id: 3, category: 'Styling', title: 'Cornrow Braid Style', stylist: 'Nandi', img: Model3, span: '' },
  { id: 4, category: 'Installs', title: 'Curly Glueless Install', stylist: 'Aisha', img: Model4, span: 'row-span-2' },
  { id: 5, category: 'Styling', title: 'Blonde Curly Ends', stylist: 'Lerato', img: Model5, span: '' },
  { id: 6, category: 'Install', title: 'Straight Fringe', stylist: 'Nandi', img: Model6, span: '' },
  { id: 7, category: 'Installs', title: 'Bob Lace Install', stylist: 'Aisha', img: Model7, span: '' },
  { id: 8, category: 'Styling', title: 'Jet Black Tint', stylist: 'Lerato', img: Model8, span: 'row-span-2' },
  { id: 9, category: 'Colour', title: 'Brown Tint', stylist: 'Nandi', img: Model9, span: '' },
  { id: 10, category: 'Installs', title: 'Lace Melt + Baby Hairs', stylist: 'Aisha', img: Model10, span: '' },
  { id: 11, category: 'Styling', title: 'Dark Brown Wavy', stylist: 'Lerato', img: Model11, span: '' },
]
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        <div className="mb-12 text-center">
          ...
          <h2 className="font-serif text-4xl font-light md:text-5xl">
            The artists behind <span className="italic text-pink-600">the look</span>
          </h2>
        </div>
      ...
      <section className="border-t border-gray-100 py-12">
        ...
        <div className="grid grid-cols-4 gap-px bg-gray-100 md:grid-cols-6 lg:grid-cols-8">
          {[Model1, Model2, Model3, Model4, Model5, Model6, Model7, Model8].map((img, i) => (
            <div key={i} className="group relative aspect-square cursor-pointer overflow-hidden bg-gray-100">
              <img
                src={img}
                alt=""
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/0 transition-colors group-hover:bg-black/30">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white opacity-0 transition-opacity group-hover:opacity-100" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="relative overflow-hidden bg-pink-600 py-24 text-center">
        ...
        <div className="relative mx-auto max-w-2xl px-6">
          ...
          <p className="mt-4 text-white/60">
            Book with one of our expert stylists and walk out looking flawless.
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link to="/booking" className="rounded-full bg-white px-7 py-3 text-sm font-medium text-pink-600 hover:opacity-90">
              Book Appointment
            </Link>
            <Link to="/services" className="rounded-full border border-white/50 px-7 py-3 text-sm text-white hover:border-white hover:bg-white/10">
              View Services
            </Link>
          </div>
        </div>
      ...
      {lightbox && (
        ...
        >
          <div
            className="relative max-h-[90vh] w-full max-w-xl overflow-hidden rounded-sm bg-white"
            ...
            <div className="flex items-center justify-between p-5">
              <div>
                ...
                <p className="mt-0.5 text-xs text-gray-400">
                  {lightbox.category} · by {lightbox.stylist}
                </p>
              </div>
              <div className="flex items-center gap-3">
                <Link
                  to="/booking"
                  className="rounded-full bg-pink-600 px-5 py-2 text-xs font-medium text-white hover:bg-pink-700"
                  onClick={() => setLightbox(null)}
                >
                  Book this look
                </Link>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/60 via-transparent to-transparent p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
        <span className="mb-1 self-start rounded-full bg-pink-600 px-2.5 py-0.5 text-xs font-medium text-white">
          {item.category}
        </span>
      ...
      <div className="absolute right-3 top-3 flex h-7 w-7 items-center justify-center rounded-full bg-white/80 opacity-0 backdrop-blur-sm transition-opacity group-hover:opacity-100">
